...
export const installJestEnzymeDependecies = async (store)=> {
  const task = {
    type: 'batch',
    // eslint-disable-next-line
    description: `Install jest${store.answers.useEnzyme ? ' and enzyme ' : ''}dependencies`,
    children: [
      {
        type: 'task',
